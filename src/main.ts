...
const DEFAULT_CSS = `
  ...
  .wechat-callout-note    { border-left-color: #888; background: #fafafa; }
  .wechat-callout-note    .wechat-callout-title { color: #555; background: #f3f3f3; }
  .wechat-callout-info    { border-left-color: #7ba7bc; background: #f8fafb; }
  .wechat-callout-info    .wechat-callout-title { color: #4a7585; background: #eef4f6; }
  .wechat-callout-tip     { border-left-color: #7ba37b; background: #f8faf8; }
  .wechat-callout-tip     .wechat-callout-title { color: #4a704a; background: #eef3ee; }
  .wechat-callout-question{ border-left-color: #b7a07b; background: #faf9f6; }
  .wechat-callout-question .wechat-callout-title { color: #7a684a; background: #f3f0ea; }
  .wechat-callout-warning { border-left-color: #bc9a7b; background: #faf7f4; }
  .wechat-callout-warning .wechat-callout-title { color: #856a4a; background: #f3eee6; }
  .wechat-callout-danger  { border-left-color: #bc7b7b; background: #faf5f5; }
  .wechat-callout-danger  .wechat-callout-title { color: #854a4a; background: #f3e6e6; }
  .wechat-callout-example { border-left-color: #7baa99; background: #f6faf9; }
  .wechat-callout-example .wechat-callout-title { color: #4a7566; background: #eaf3f0; }
  .wechat-callout-quote   { border-left-color: #999; background: #f8f8f8; }
  .wechat-callout-quote   .wechat-callout-title { color: #666; background: #eee; }
...
/** Render LaTeX formula to WeChat-safe SVG via codecogs. */
async function renderLatexSvg(formula: string): Promise<string> {
	try {
...
export default class WechatCopyPlugin extends Plugin {
	...
	async processMarkdown(markdown: string, currentPath: string): Promise<string> {
		...
		let latexIdx = 0;
		const withLatexPH = unescaped.replace(/\$\$([\s\S]+?)\$\$/g, (_m, f: string) => {
			const ph = `\uE000LATEX${latexIdx}\uE000`; latexMap.set(ph, f.trim()); latexIdx++; return ph;
		...
		for (const [ph, formula] of latexMap) {
			const svg = await renderLatexSvg(formula);
	...
	async processAndPreview(markdown: string, currentPath: string) {
		...
		try {
			...
			const fname = currentPath.split('/').pop()?.replace(/\.md$/, '') || '';
...
html.dark .wechat-callout-tip     { border-left-color: rgba(123,163,123,0.6)!important; background: rgba(123,163,123,0.12)!important }
html.dark .wechat-callout-tip     .wechat-callout-title { color: #8db88d!important; background: rgba(123,163,123,0.2)!important }
html.dark .wechat-callout-question{ border-left-color: rgba(183,160,123,0.6)!important; background: rgba(183,160,123,0.12)!important }
html.dark .wechat-callout-question .wechat-callout-title { color: #c8b88d!important; background: rgba(183,160,123,0.2)!important }
html.dark .wechat-callout-warning { border-left-color: rgba(188,154,123,0.6)!important; background: rgba(188,154,123,0.12)!important }
html.dark .wechat-callout-warning .wechat-callout-title { color: #c8a88d!important; background: rgba(188,154,123,0.2)!important }
html.dark .wechat-callout-danger  { border-left-color: rgba(188,123,123,0.6)!important; background: rgba(188,123,123,0.12)!important }
html.dark .wechat-callout-danger  .wechat-callout-title { color: #c88d8d!important; background: rgba(188,123,123,0.2)!important }
html.dark .wechat-callout-example { border-left-color: rgba(123,170,153,0.6)!important; background: rgba(123,170,153,0.12)!important }
html.dark .wechat-callout-example .wechat-callout-title { color: #8dc8b0!important; background: rgba(123,170,153,0.2)!important }
html.dark .wechat-callout-quote   { border-left-color: rgba(153,153,153,0.6)!important; background: rgba(153,153,153,0.12)!important }
...
@media(prefers-color-scheme:dark){
  ...
  html:not(.light) .wechat-callout-tip     { border-left-color: rgba(123,163,123,0.6)!important; background: rgba(123,163,123,0.12)!important }
  html:not(.light) .wechat-callout-tip     .wechat-callout-title { color: #8db88d!important; background: rgba(123,163,123,0.2)!important }
  html:not(.light) .wechat-callout-question{ border-left-color: rgba(183,160,123,0.6)!important; background: rgba(183,160,123,0.12)!important }
  ...
  html:not(.light) .wechat-callout-warning { border-left-color: rgba(188,154,123,0.6)!important; background: rgba(188,154,123,0.12)!important }
  ...
  html:not(.light) .wechat-callout-danger  { border-left-color: rgba(188,123,123,0.6)!important; background: rgba(188,123,123,0.12)!important }
  ...
  html:not(.light) .wechat-callout-example { border-left-color: rgba(123,170,153,0.6)!important; background: rgba(123,170,153,0.12)!important }
  ...
  html:not(.light) .wechat-callout-quote   { border-left-color: rgba(153,153,153,0.6)!important; background: rgba(153,153,153,0.12)!important }
...
class WechatSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(containerEl)
			.setName('Reset style')
			.setDesc('Click to reset style to the default minimalist diary theme')
