...
> 版本: 1.1.0 | 最后更新: 2026-08-19 | 适用: obsidian-wechat-publish
...
- **插件**: `ARCJ137442/obsidian-wechat-publish` v1.1.0 (forked from `tinyking/obsidian-wechat-publish`, MIT)
...
- 不接入微信公众号 API；复制 HTML 后由用户在公众号后台完成发布
